...
const OldTestament = () => {
  ...
  //placeholder
  const [bookPlaceholder, setBookPlaceholder] = useState('Matthew');
  ...
  const getListOfBooks = async () => {
    ...
    await axios({
      ...
      .then(({data}) => {
        ...
        setListOfBooksAndroid(data.slice(39, 66));
        let firstTestament;
        data ? (firstTestament = data.slice(39, 66)) : null;
        const sort = [];
