...
<module external.linked.project.id=":react-native-paystack" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-paystack" />
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: co.paystack.android.design.widget:pinpad:1.0.1@aar" level="project" />
    ...
    <orderEntry type="library" name="Gradle: co.paystack.android:paystack:3.0.12@aar" level="project" />
  </component>
</module>